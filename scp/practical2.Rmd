...
Since we are running multiple similar tests, we need to apply a false discovery rate (fdr) correctios and correcting across all features will most likely result in no significant results after fdr correction. Also, you don’t want to look at over 14.000 P-values, do you?
